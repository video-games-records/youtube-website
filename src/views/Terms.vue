...
const loadComponent = async () => {
  ...
  try {
    console.log('Loading Terms for locale:', locale.value)

    let component
    switch (locale.value) {
      case 'fr':
        component = (await import('./terms/Terms.fr.vue')).default
        break
      case 'en':
      default:
        component = (await import('./terms/Terms.en.vue')).default
        break
    }
  ...
  <div>
    ...
    <div v-if="isLoading" class="flex justify-center items-center min-h-[50vh]">
      <div class="text-center">
        ...
        <p class="text-muted-foreground">Loading Terms of Service...</p>
      </div>
    </div>
    ...
    <div v-else class="flex justify-center items-center min-h-[50vh]">
      <p class="text-muted-foreground">Failed to load Terms of Service content</p>
    </div>
  </div>
</template>
